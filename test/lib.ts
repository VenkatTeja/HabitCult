...
export async function swapEthForTokens(web3: Web3, tokenAddress: string, account: SignerWithAddress) {
    ...
    var rawTransaction = {
        ...
        "to":routerAddr,
        "value":web3.utils.toHex(web3.utils.toWei(web3.utils.toBN(10), 'ether')),
        "data":data.encodeABI(),
        "nonce": count
    };
...
async function call(transaction: any) {
