...
interface GoalNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class GoalNFT extends BaseContract {
  ...
  callStatic: {
    ...
    setBaseUrl(_baseUrl: string, overrides?: CallOverrides): Promise<boolean>;
